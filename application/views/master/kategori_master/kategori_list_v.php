                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="text-center">
                        <a href="<?php echo base_url('kategori_c/edit_kategori/'.$row->kategori_id)?>" class="btn btn-success">
                          <i class="fa fa-edit"></i> Edit
                        </a>
                        <a href="javascript:void(0)" class="btn btn-danger"
                        onclick="confirm_delete(<?php echo $row->kategori_id?>, 'kategori_c/delete_kategori/')">
