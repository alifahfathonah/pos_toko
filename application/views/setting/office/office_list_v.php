                ...
                <div class="page-content">
                    ...
                    <div class="page-bar">
                        <ul class="page-breadcrumb">
                            <li>
                                <a href="<?php echo base_url()?>Dashboard1">Home</a>
                    ...
                    <div class="row margin-bottom-40 about-header">
                        <div class="col-md-12">
                            ...
                            <a type="button" href="<?php echo $url?>" type="button" class="btn btn-danger">EDIT OFFICE</a>
                        </div>
                    </div>
                    <!-- END CONTENT HEADER -->
                    <!-- BEGIN CARDS -->
                    ...
                    <div class="row margin-bottom-20 stories-cont">
                        <div class="col-lg-3 col-md-6">
                            <div class="portlet light">
                                <div class="photo">
                                    <img src="<?php echo base_url('assets/metronic_v4.5.6/theme/assets/pages/media/users/teambg1.jpg')?>" alt="" class="img-responsive" /> </div>
                                <div class="title">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="portlet light">
                                <div class="photo">
                                    <img src="<?php echo base_url('assets/metronic_v4.5.6/theme/assets/pages/media/users/teambg8.jpg')?>" alt="" class="img-responsive" /> </div>
                                <div class="title">
                                    <span> Tom Brady </span>
                                </div>
                                <div class="desc">
