...
<script src="<?php echo base_url('assets/metronic_v4.5.6/theme/assets/pages/scripts/components-date-time-pickers.min.js')?>" type="text/javascript"></script>
<script src="<?php echo base_url('assets/metronic_v4.5.6/theme/assets/pages/scripts/ui-general.min.js')?>" type="text/javascript"></script>
<!-- BEGIN PAGE LEVEL SCRIPTS -->
<script src="<?php echo base_url('assets/metronic_v4.5.6/theme/assets/global/plugins/jquery-bootpag/jquery.bootpag.min.js')?>" type="text/javascript"></script>
...
<script src="<?php echo base_url('assets/metronic_v4.5.6/theme/assets/layouts/layout5/scripts/layout.min.js')?>" type="text/javascript"></script>
